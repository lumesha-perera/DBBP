...
public class DBBPPageFactory {
	public static com.epic.acrs.web.PageFactory.DBBPPageFactory pf = PageFactory.initElements(WebDriverHelper.getWebDriver(), com.epic.acrs.web.PageFactory.DBBPPageFactory.class);
